...
public class NameTree extends NameStoreTree {
	...
	public NameTree(final File file, final int maxNameLength, final int maxKeys) {
		super(maxNameLength);
		...
		try {
			...
			if(false) {
				...
				ByteBuffer bb = ByteBuffer.allocate(3*IB+nodeSize);
